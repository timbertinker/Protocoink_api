...
export interface Executor extends BaseContract {
    ...
    functions: {
        executeFromAgent(tos_: string[], datas_: BytesLike[], values_: BigNumberish[], overrides?: Overrides & {
            from?: string;
    ...
    callStatic: {
        executeFromAgent(tos_: string[], datas_: BytesLike[], values_: BigNumberish[], overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        executeFromAgent(tos_: string[], datas_: BytesLike[], values_: BigNumberish[], overrides?: Overrides & {
