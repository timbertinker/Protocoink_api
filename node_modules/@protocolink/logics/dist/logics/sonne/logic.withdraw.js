...
class WithdrawLogic extends core.Logic {
    ...
    async quote(params) {
        ...
        const exchangeRateCurrent = await contracts_1.CErc20Immutable__factory.connect(input.token.address, this.provider).callStatic.exchangeRateCurrent();
    ...
    async build(fields) {
        ...
        const data = contracts_1.CErc20Immutable__factory.createInterface().encodeFunctionData('redeem', [input.amountWei]);
...
WithdrawLogic.protocolId = 'sonne';
