...
export interface CErc20ImmutableInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'initialize(address,address,address,uint256,string,string,uint8)', values: [string, string, string, BigNumberish, string, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: 'initialize(address,address,uint256,string,string,uint8)', values: [string, string, BigNumberish, string, string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: 'initialize(address,address,address,uint256,string,string,uint8)', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'initialize(address,address,uint256,string,string,uint8)', data: BytesLike): Result;
