...
export type SwapTokenLogicFields = core.TokenToTokenFields<{
    path: string[];
    slippage?: number;
}>;
...
export declare class SwapTokenLogic extends core.Logic implements core.LogicTokenListInterface, core.LogicOracleInterface, core.LogicBuilderInterface {
    ...
    getAllCommonPairs(tokenA: Token, tokenB: Token, isAll?: boolean): Promise<Pair[]>;
    generateAllRoutePairs(tokenA?: Token, tokenB?: Token): [Token, Token][];
    getPairAddresses(pairTokens: Token[][]): Promise<Array<string | undefined>>;
}
