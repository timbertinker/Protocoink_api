...
import type { MagicSeaPair, MagicSeaPairInterface } from '../MagicSeaPair';
export declare class MagicSeaPair__factory {
    static readonly abi: readonly [{
        ...
        readonly name: "FeeAmountUpdated";
        readonly type: "event";
    }, {
        readonly anonymous: false;
        readonly inputs: readonly [{
    ...
    static createInterface(): MagicSeaPairInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): MagicSeaPair;
}
