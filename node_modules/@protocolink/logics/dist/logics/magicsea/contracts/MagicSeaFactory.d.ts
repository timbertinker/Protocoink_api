...
export interface MagicSeaFactoryInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: 'FEE_DENOMINATOR' | 'INIT_CODE_PAIR_HASH' | 'OWNER_FEE_SHARE_MAX' | 'allPairs' | 'allPairsLength' | 'createPair' | 'feeTo' | 'feeToSetter' | 'getPair' | 'ownerFeeShare' | 'setFeeTo' | 'setFeeToSetter' | 'setOwnerFeeShare'): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: 'setOwnerFeeShare', values: [BigNumberish]): string;
...
export interface MagicSeaFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MagicSeaFactoryInterface;
    ...
    functions: {
        ...
        setOwnerFeeShare(newOwnerFeeShare: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    FEE_DENOMINATOR(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        ...
        setOwnerFeeShare(newOwnerFeeShare: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
