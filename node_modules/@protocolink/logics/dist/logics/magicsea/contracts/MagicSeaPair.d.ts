...
export interface MagicSeaPairInterface extends utils.Interface {
    functions: {
        'FEE_DENOMINATOR()': FunctionFragment;
        'MAX_FEE_AMOUNT()': FunctionFragment;
        'MINIMUM_LIQUIDITY()': FunctionFragment;
        'MIN_FEE_AMOUNT()': FunctionFragment;
    ...
    encodeFunctionData(functionFragment: 'MIN_FEE_AMOUNT', values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: 'MIN_FEE_AMOUNT', data: BytesLike): Result;
    ...
    events: {
        ...
        'FeeAmountUpdated(uint256,uint256)': EventFragment;
    ...
    getEvent(nameOrSignatureOrTopic: 'FeeAmountUpdated'): EventFragment;
...
export interface FeeAmountUpdatedEventObject {
    prevFeeAmount: BigNumber;
    feeAmount: BigNumber;
}
export type FeeAmountUpdatedEvent = TypedEvent<[BigNumber, BigNumber], FeeAmountUpdatedEventObject>;
export type FeeAmountUpdatedEventFilter = TypedEventFilter<FeeAmountUpdatedEvent>;
...
export interface MagicSeaPair extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MagicSeaPairInterface;
    ...
    functions: {
        ...
        MAX_FEE_AMOUNT(overrides?: CallOverrides): Promise<[BigNumber]>;
        MINIMUM_LIQUIDITY(overrides?: CallOverrides): Promise<[BigNumber]>;
        MIN_FEE_AMOUNT(overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        setFeeAmount(newFeeAmount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        price0CumulativeLast(overrides?: CallOverrides): Promise<BigNumber>;
        price1CumulativeLast(overrides?: CallOverrides): Promise<BigNumber>;
        setFeeAmount(newFeeAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        'FeeAmountUpdated(uint256,uint256)'(prevFeeAmount?: null, feeAmount?: null): FeeAmountUpdatedEventFilter;
        FeeAmountUpdated(prevFeeAmount?: null, feeAmount?: null): FeeAmountUpdatedEventFilter;
    ...
    populateTransaction: {
        ...
        MAX_FEE_AMOUNT(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        MINIMUM_LIQUIDITY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        MIN_FEE_AMOUNT(overrides?: CallOverrides): Promise<PopulatedTransaction>;
