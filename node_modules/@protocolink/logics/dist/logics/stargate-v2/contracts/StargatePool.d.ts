...
export declare namespace StargateBase {
    ...
    type AddressConfigStructOutput = [string, string, string, string, string, string] & {
        feeLib: string;
        planner: string;
        treasurer: string;
        tokenMessaging: string;
...
export interface StargatePoolInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'addTreasuryFee', values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: 'allowBurn', values: [string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'quoteRedeemSend', values: [SendParamStruct, boolean]): string;
    encodeFunctionData(functionFragment: 'quoteSend', values: [SendParamStruct, boolean]): string;
    encodeFunctionData(functionFragment: 'receiveCredits', values: [BigNumberish, CreditStruct[]]): string;
    encodeFunctionData(functionFragment: 'receiveTokenBus', values: [OriginStruct, BytesLike, BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: 'receiveTokenTaxi', values: [OriginStruct, BytesLike, string, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: 'recoverToken', values: [string, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: 'redeem', values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: 'redeemSend', values: [SendParamStruct, MessagingFeeStruct, string]): string;
    encodeFunctionData(functionFragment: 'redeemable', values: [string]): string;
    encodeFunctionData(functionFragment: 'renounceOwnership', values?: undefined): string;
    encodeFunctionData(functionFragment: 'retryReceiveToken', values: [BytesLike, BigNumberish, BigNumberish, string, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: 'send', values: [SendParamStruct, MessagingFeeStruct, string]): string;
    encodeFunctionData(functionFragment: 'sendCredits', values: [BigNumberish, TargetCreditStruct[]]): string;
    encodeFunctionData(functionFragment: 'sendToken', values: [SendParamStruct, MessagingFeeStruct, string]): string;
    encodeFunctionData(functionFragment: 'setAddressConfig', values: [StargateBase.AddressConfigStruct]): string;
    encodeFunctionData(functionFragment: 'setDeficitOffset', values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: 'setOFTPath', values: [BigNumberish, boolean]): string;
    ...
    encodeFunctionData(functionFragment: 'unreceivedTokens', values: [BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: 'withdrawPlannerFee', values?: undefined): string;
    encodeFunctionData(functionFragment: 'withdrawTreasuryFee', values: [string, BigNumberish]): string;
...
export interface StargatePool extends BaseContract {
    ...
    functions: {
        addTreasuryFee(_amountLD: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        allowBurn(_burnAdmin: string, _burnAllowanceSD: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        deposit(_receiver: string, _amountLD: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        paths(eid: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber] & {
            credit: BigNumber;
        }>;
        ...
        quoteRedeemSend(_sendParam: SendParamStruct, _payInLzToken: boolean, overrides?: CallOverrides): Promise<[MessagingFeeStructOutput] & {
            fee: MessagingFeeStructOutput;
        }>;
        quoteSend(_sendParam: SendParamStruct, _payInLzToken: boolean, overrides?: CallOverrides): Promise<[MessagingFeeStructOutput] & {
            fee: MessagingFeeStructOutput;
        }>;
        receiveCredits(_srcEid: BigNumberish, _credits: CreditStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        receiveTokenBus(_origin: OriginStruct, _guid: BytesLike, _seatNumber: BigNumberish, _receiver: string, _amountSD: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        receiveTokenTaxi(_origin: OriginStruct, _guid: BytesLike, _receiver: string, _amountSD: BigNumberish, _composeMsg: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        recoverToken(_token: string, _to: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        redeem(_amountLD: BigNumberish, _receiver: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        redeemSend(_sendParam: SendParamStruct, _fee: MessagingFeeStruct, _refundAddress: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        redeemable(_owner: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            amountLD: BigNumber;
        }>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        retryReceiveToken(_guid: BytesLike, _index: BigNumberish, _srcEid: BigNumberish, _receiver: string, _amountLD: BigNumberish, _composeMsg: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        send(_sendParam: SendParamStruct, _fee: MessagingFeeStruct, _refundAddress: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        sendCredits(_dstEid: BigNumberish, _credits: TargetCreditStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        sendToken(_sendParam: SendParamStruct, _fee: MessagingFeeStruct, _refundAddress: string, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setAddressConfig(_config: StargateBase.AddressConfigStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setDeficitOffset(_deficitOffsetLD: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setOFTPath(_dstEid: BigNumberish, _oft: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setPause(_paused: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setTransferGasLimit(_gasLimit: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        unreceivedTokens(guid: BytesLike, index: BigNumberish, overrides?: CallOverrides): Promise<[string] & {
            hash: string;
        }>;
        withdrawPlannerFee(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        withdrawTreasuryFee(_to: string, _amountSD: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    addTreasuryFee(_amountLD: BigNumberish, overrides?: PayableOverrides & {
    ...
    callStatic: {
        addTreasuryFee(_amountLD: BigNumberish, overrides?: CallOverrides): Promise<void>;
        allowBurn(_burnAdmin: string, _burnAllowanceSD: BigNumberish, overrides?: CallOverrides): Promise<void>;
        approvalRequired(overrides?: CallOverrides): Promise<boolean>;
        burnAdmin(overrides?: CallOverrides): Promise<string>;
        burnAllowanceSD(overrides?: CallOverrides): Promise<BigNumber>;
        burnLockedUSDC(overrides?: CallOverrides): Promise<void>;
        deficitOffset(overrides?: CallOverrides): Promise<BigNumber>;
        deposit(_receiver: string, _amountLD: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        endpoint(overrides?: CallOverrides): Promise<string>;
        getAddressConfig(overrides?: CallOverrides): Promise<StargateBase.AddressConfigStructOutput>;
        getTransferGasLimit(overrides?: CallOverrides): Promise<BigNumber>;
        localEid(overrides?: CallOverrides): Promise<number>;
        ...
        quoteRedeemSend(_sendParam: SendParamStruct, _payInLzToken: boolean, overrides?: CallOverrides): Promise<MessagingFeeStructOutput>;
        quoteSend(_sendParam: SendParamStruct, _payInLzToken: boolean, overrides?: CallOverrides): Promise<MessagingFeeStructOutput>;
        receiveCredits(_srcEid: BigNumberish, _credits: CreditStruct[], overrides?: CallOverrides): Promise<void>;
        receiveTokenBus(_origin: OriginStruct, _guid: BytesLike, _seatNumber: BigNumberish, _receiver: string, _amountSD: BigNumberish, overrides?: CallOverrides): Promise<void>;
        receiveTokenTaxi(_origin: OriginStruct, _guid: BytesLike, _receiver: string, _amountSD: BigNumberish, _composeMsg: BytesLike, overrides?: CallOverrides): Promise<void>;
        recoverToken(_token: string, _to: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        redeem(_amountLD: BigNumberish, _receiver: string, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        retryReceiveToken(_guid: BytesLike, _index: BigNumberish, _srcEid: BigNumberish, _receiver: string, _amountLD: BigNumberish, _composeMsg: BytesLike, overrides?: CallOverrides): Promise<void>;
        ...
        sendCredits(_dstEid: BigNumberish, _credits: TargetCreditStruct[], overrides?: CallOverrides): Promise<CreditStructOutput[]>;
        ...
        setDeficitOffset(_deficitOffsetLD: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setOFTPath(_dstEid: BigNumberish, _oft: boolean, overrides?: CallOverrides): Promise<void>;
        setPause(_paused: boolean, overrides?: CallOverrides): Promise<void>;
        setTransferGasLimit(_gasLimit: BigNumberish, overrides?: CallOverrides): Promise<void>;
        sharedDecimals(overrides?: CallOverrides): Promise<number>;
        stargateType(overrides?: CallOverrides): Promise<number>;
        status(overrides?: CallOverrides): Promise<number>;
        token(overrides?: CallOverrides): Promise<string>;
        ...
        withdrawTreasuryFee(_to: string, _amountSD: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        ...
        'Deposited(address,address,uint256)'(payer?: string | null, receiver?: string | null, amountLD?: null): DepositedEventFilter;
        Deposited(payer?: string | null, receiver?: string | null, amountLD?: null): DepositedEventFilter;
        'OFTPathSet(uint32,bool)'(dstEid?: null, oft?: null): OFTPathSetEventFilter;
        OFTPathSet(dstEid?: null, oft?: null): OFTPathSetEventFilter;
        'OFTReceived(bytes32,uint32,address,uint256)'(guid?: BytesLike | null, srcEid?: null, toAddress?: string | null, amountReceivedLD?: null): OFTReceivedEventFilter;
        OFTReceived(guid?: BytesLike | null, srcEid?: null, toAddress?: string | null, amountReceivedLD?: null): OFTReceivedEventFilter;
        'OFTSent(bytes32,uint32,address,uint256,uint256)'(guid?: BytesLike | null, dstEid?: null, fromAddress?: string | null, amountSentLD?: null, amountReceivedLD?: null): OFTSentEventFilter;
        OFTSent(guid?: BytesLike | null, dstEid?: null, fromAddress?: string | null, amountSentLD?: null, amountReceivedLD?: null): OFTSentEventFilter;
        ...
        'Redeemed(address,address,uint256)'(payer?: string | null, receiver?: string | null, amountLD?: null): RedeemedEventFilter;
        Redeemed(payer?: string | null, receiver?: string | null, amountLD?: null): RedeemedEventFilter;
    ...
    estimateGas: {
        ...
        quoteRedeemSend(_sendParam: SendParamStruct, _payInLzToken: boolean, overrides?: CallOverrides): Promise<BigNumber>;
        quoteSend(_sendParam: SendParamStruct, _payInLzToken: boolean, overrides?: CallOverrides): Promise<BigNumber>;
        receiveCredits(_srcEid: BigNumberish, _credits: CreditStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        receiveTokenBus(_origin: OriginStruct, _guid: BytesLike, _seatNumber: BigNumberish, _receiver: string, _amountSD: BigNumberish, overrides?: Overrides & {
        ...
        treasuryFee(overrides?: CallOverrides): Promise<BigNumber>;
        tvl(overrides?: CallOverrides): Promise<BigNumber>;
        unreceivedTokens(guid: BytesLike, index: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        withdrawPlannerFee(overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        withdrawTreasuryFee(_to: string, _amountSD: BigNumberish, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        paths(eid: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        quoteRedeemSend(_sendParam: SendParamStruct, _payInLzToken: boolean, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        quoteSend(_sendParam: SendParamStruct, _payInLzToken: boolean, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        receiveCredits(_srcEid: BigNumberish, _credits: CreditStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        receiveTokenBus(_origin: OriginStruct, _guid: BytesLike, _seatNumber: BigNumberish, _receiver: string, _amountSD: BigNumberish, overrides?: Overrides & {
        ...
        redeemable(_owner: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        retryReceiveToken(_guid: BytesLike, _index: BigNumberish, _srcEid: BigNumberish, _receiver: string, _amountLD: BigNumberish, _composeMsg: BytesLike, overrides?: Overrides & {
        ...
        unreceivedTokens(guid: BytesLike, index: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        withdrawPlannerFee(overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        withdrawTreasuryFee(_to: string, _amountSD: BigNumberish, overrides?: Overrides & {
