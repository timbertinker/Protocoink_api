...
class FlashLoanLogic extends core.Logic {
    get callbackAddress() {
        return (0, configs_1.getContractAddress)(this.chainId, 'AaveV2FlashLoanCallback');
    }
    async calcCallbackFee(loan) {
        const callback = contracts_1.AaveV2FlashLoanCallback__factory.connect(this.callbackAddress, this.provider);
...
FlashLoanLogic.protocolId = 'aave-v2';
