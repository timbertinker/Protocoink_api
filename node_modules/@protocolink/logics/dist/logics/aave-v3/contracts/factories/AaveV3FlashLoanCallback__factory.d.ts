...
export declare class AaveV3FlashLoanCallback__factory {
    ...
    static createInterface(): AaveV3FlashLoanCallbackInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): AaveV3FlashLoanCallback;
}
