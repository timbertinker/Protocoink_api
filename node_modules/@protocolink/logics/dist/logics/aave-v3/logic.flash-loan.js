...
class FlashLoanLogic extends core.Logic {
    get callbackAddress() {
        return (0, configs_1.getContractAddress)(this.chainId, 'AaveV3FlashLoanCallback');
    }
    async calcCallbackFee(loan) {
        const callback = contracts_1.AaveV3FlashLoanCallback__factory.connect(this.callbackAddress, this.provider);
...
FlashLoanLogic.protocolId = 'aave-v3';
