...
export interface CometRewards extends BaseContract {
    ...
    functions: {
        ...
        claimTo(comet: string, src: string, to: string, shouldAccrue: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setRewardConfig(comet: string, token: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        transferGovernor(newGovernor: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        withdrawToken(token: string, to: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    claim(comet: string, src: string, shouldAccrue: boolean, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        getRewardOwed(comet: string, account: string, overrides?: CallOverrides): Promise<CometRewards.RewardOwedStructOutput>;
        governor(overrides?: CallOverrides): Promise<string>;
        rewardConfig(arg0: string, overrides?: CallOverrides): Promise<[
            string,
            BigNumber,
    ...
    filters: {
        'GovernorTransferred(address,address)'(oldGovernor?: string | null, newGovernor?: string | null): GovernorTransferredEventFilter;
        GovernorTransferred(oldGovernor?: string | null, newGovernor?: string | null): GovernorTransferredEventFilter;
        'RewardClaimed(address,address,address,uint256)'(src?: string | null, recipient?: string | null, token?: string | null, amount?: null): RewardClaimedEventFilter;
        RewardClaimed(src?: string | null, recipient?: string | null, token?: string | null, amount?: null): RewardClaimedEventFilter;
    };
    estimateGas: {
        claim(comet: string, src: string, shouldAccrue: boolean, overrides?: Overrides & {
            from?: string;
