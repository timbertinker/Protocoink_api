...
export interface MorphoInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'liquidate', values: [MarketParamsStruct, string, BigNumberish, BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: 'repay', values: [MarketParamsStruct, BigNumberish, BigNumberish, string, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: 'supply', values: [MarketParamsStruct, BigNumberish, BigNumberish, string, BytesLike]): string;
    encodeFunctionData(functionFragment: 'supplyCollateral', values: [MarketParamsStruct, BigNumberish, string, BytesLike]): string;
    encodeFunctionData(functionFragment: 'withdraw', values: [MarketParamsStruct, BigNumberish, BigNumberish, string, string]): string;
    encodeFunctionData(functionFragment: 'withdrawCollateral', values: [MarketParamsStruct, BigNumberish, string, string]): string;
...
export interface Morpho extends BaseContract {
    ...
    functions: {
        ...
        accrueInterest(marketParams: MarketParamsStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        borrow(marketParams: MarketParamsStruct, assets: BigNumberish, shares: BigNumberish, onBehalf: string, receiver: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        createMarket(marketParams: MarketParamsStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        enableIrm(irm: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        enableLltv(lltv: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        flashLoan(token: string, assets: BigNumberish, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        idToMarketParams(arg0: BytesLike, overrides?: CallOverrides): Promise<[
            string,
            string,
            string,
            string,
        ...
        liquidate(marketParams: MarketParamsStruct, borrower: string, seizedAssets: BigNumberish, repaidShares: BigNumberish, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        market(arg0: BytesLike, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
            BigNumber,
        ...
        position(arg0: BytesLike, arg1: string, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber
        ] & {
        ...
        repay(marketParams: MarketParamsStruct, assets: BigNumberish, shares: BigNumberish, onBehalf: string, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setAuthorization(authorized: string, newIsAuthorized: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setAuthorizationWithSig(authorization: AuthorizationStruct, signature: SignatureStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setFee(marketParams: MarketParamsStruct, newFee: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        supply(marketParams: MarketParamsStruct, assets: BigNumberish, shares: BigNumberish, onBehalf: string, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        supplyCollateral(marketParams: MarketParamsStruct, assets: BigNumberish, onBehalf: string, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        withdraw(marketParams: MarketParamsStruct, assets: BigNumberish, shares: BigNumberish, onBehalf: string, receiver: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        withdrawCollateral(marketParams: MarketParamsStruct, assets: BigNumberish, onBehalf: string, receiver: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    DOMAIN_SEPARATOR(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        borrow(marketParams: MarketParamsStruct, assets: BigNumberish, shares: BigNumberish, onBehalf: string, receiver: string, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        ...
        isIrmEnabled(arg0: string, overrides?: CallOverrides): Promise<boolean>;
        isLltvEnabled(arg0: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        liquidate(marketParams: MarketParamsStruct, borrower: string, seizedAssets: BigNumberish, repaidShares: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        market(arg0: BytesLike, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
        ...
        repay(marketParams: MarketParamsStruct, assets: BigNumberish, shares: BigNumberish, onBehalf: string, data: BytesLike, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        setAuthorization(authorized: string, newIsAuthorized: boolean, overrides?: CallOverrides): Promise<void>;
        setAuthorizationWithSig(authorization: AuthorizationStruct, signature: SignatureStruct, overrides?: CallOverrides): Promise<void>;
        ...
        supply(marketParams: MarketParamsStruct, assets: BigNumberish, shares: BigNumberish, onBehalf: string, data: BytesLike, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        supplyCollateral(marketParams: MarketParamsStruct, assets: BigNumberish, onBehalf: string, data: BytesLike, overrides?: CallOverrides): Promise<void>;
        withdraw(marketParams: MarketParamsStruct, assets: BigNumberish, shares: BigNumberish, onBehalf: string, receiver: string, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        withdrawCollateral(marketParams: MarketParamsStruct, assets: BigNumberish, onBehalf: string, receiver: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
