...
export interface MorphoFlashLoanCallbackInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'feeRate' | 'flashLoan' | 'metadata' | 'morpho' | 'onMorphoFlashLoan' | 'router'): FunctionFragment;
...
export interface MorphoFlashLoanCallback extends BaseContract {
    ...
    functions: {
        ...
        onMorphoFlashLoan(assets: BigNumberish, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
