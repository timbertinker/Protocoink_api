...
export declare class FlashLoanLogic extends core.Logic implements core.LogicTokenListInterface, core.LogicBuilderInterface {
    static id: string;
    static protocolId: string;
    static readonly supportedChainIds: number[];
    get callbackAddress(): string;
    calcCallbackFee(loan: common.TokenAmount): Promise<common.TokenAmount>;
    getTokenList(): Promise<FlashLoanLogicTokenList>;
    quote(params: FlashLoanLogicParams): Promise<FlashLoanLogicQuotation>;
