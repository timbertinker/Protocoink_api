...
export interface RadiantV2FlashLoanCallbackInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'executeOperation' | 'feeRate' | 'metadata' | 'radiantV2Provider' | 'router'): FunctionFragment;
...
export interface RadiantV2FlashLoanCallback extends BaseContract {
    ...
    functions: {
        executeOperation(assets: string[], amounts: BigNumberish[], premiums: BigNumberish[], arg3: string, params: BytesLike, overrides?: Overrides & {
            from?: string;
    ...
    router(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        executeOperation(assets: string[], amounts: BigNumberish[], premiums: BigNumberish[], arg3: string, params: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        feeRate(overrides?: CallOverrides): Promise<BigNumber>;
        metadata(overrides?: CallOverrides): Promise<string>;
        radiantV2Provider(overrides?: CallOverrides): Promise<string>;
        router(overrides?: CallOverrides): Promise<string>;
