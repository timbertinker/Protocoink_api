...
export interface AToken extends BaseContract {
    ...
    functions: {
        ...
        initialize(underlyingAssetDecimals: BigNumberish, tokenName: string, tokenSymbol: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initialize(underlyingAssetDecimals: BigNumberish, tokenName: string, tokenSymbol: string, overrides?: CallOverrides): Promise<void>;
