...
export interface BalancerV2FlashLoanCallbackInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'balancerV2Vault' | 'feeRate' | 'metadata' | 'receiveFlashLoan' | 'router'): FunctionFragment;
...
export interface BalancerV2FlashLoanCallback extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BalancerV2FlashLoanCallbackInterface;
