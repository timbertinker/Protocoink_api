...
export interface VaultInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'queryBatchSwap', values: [BigNumberish, IVault.BatchSwapStepStruct[], string[], IVault.FundManagementStruct]): string;
    ...
    encodeFunctionData(functionFragment: 'swap', values: [IVault.SingleSwapStruct, IVault.FundManagementStruct, BigNumberish, BigNumberish]): string;
