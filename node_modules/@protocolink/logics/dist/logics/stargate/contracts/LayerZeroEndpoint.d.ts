...
export interface LayerZeroEndpointInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'BLOCK_VERSION' | 'DEFAULT_VERSION' | 'chainId' | 'defaultReceiveLibraryAddress' | 'defaultReceiveVersion' | 'defaultSendLibrary' | 'defaultSendVersion' | 'estimateFees' | 'forceResumeReceive' | 'getChainId' | 'getConfig' | 'getInboundNonce' | 'getOutboundNonce' | 'getReceiveLibraryAddress' | 'getReceiveVersion' | 'getSendLibraryAddress' | 'getSendVersion' | 'hasStoredPayload' | 'inboundNonce' | 'isReceivingPayload' | 'isSendingPayload' | 'latestVersion' | 'libraryLookup' | 'newVersion' | 'outboundNonce' | 'owner' | 'receivePayload' | 'renounceOwnership' | 'retryPayload' | 'send' | 'setConfig' | 'setDefaultReceiveVersion' | 'setDefaultSendVersion' | 'setReceiveVersion' | 'setSendVersion' | 'storedPayload' | 'transferOwnership' | 'uaConfigLookup'): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: 'receivePayload', values: [BigNumberish, BytesLike, string, BigNumberish, BigNumberish, BytesLike]): string;
...
export interface LayerZeroEndpoint extends BaseContract {
    ...
    functions: {
        ...
        estimateFees(_dstChainId: BigNumberish, _userApplication: string, _payload: BytesLike, _payInZRO: boolean, _adapterParams: BytesLike, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            nativeFee: BigNumber;
            zroFee: BigNumber;
        }>;
        ...
        newVersion(_newLayerZeroLibraryAddress: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setDefaultReceiveVersion(_newDefaultReceiveVersion: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setDefaultSendVersion(_newDefaultSendVersion: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setReceiveVersion(_newVersion: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setSendVersion(_newVersion: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        uaConfigLookup(arg0: string, overrides?: CallOverrides): Promise<[
            number,
            number,
            string,
            string
