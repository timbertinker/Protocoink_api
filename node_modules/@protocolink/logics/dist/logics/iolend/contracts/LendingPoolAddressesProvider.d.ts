...
export interface LendingPoolAddressesProviderInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'setLiquidationFeeTo', values: [string]): string;
...
export interface LendingPoolAddressesProvider extends BaseContract {
    ...
    functions: {
        ...
        setAddressAsProxy(id: BytesLike, implementationAddress: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setEmergencyAdmin(emergencyAdmin: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setLiquidationFeeTo(liquidationFeeTo: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setLiquidationFeeTo(liquidationFeeTo: string, overrides?: CallOverrides): Promise<void>;
