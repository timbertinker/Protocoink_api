...
export interface LendingPoolInterface extends utils.Interface {
    functions: {
        ...
        'delegateWithdraw(address)': FunctionFragment;
        ...
        'undelegateWithdraw(address)': FunctionFragment;
        'withdraw(address,uint256,address)': FunctionFragment;
        'withdraw(address,uint256,address,address)': FunctionFragment;
        'withdrawDelegatesOf(address)': FunctionFragment;
    };
    ...
    encodeFunctionData(functionFragment: 'delegateWithdraw', values: [string]): string;
    ...
    encodeFunctionData(functionFragment: 'undelegateWithdraw', values: [string]): string;
    encodeFunctionData(functionFragment: 'withdraw(address,uint256,address)', values: [string, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: 'withdraw(address,uint256,address,address)', values: [string, BigNumberish, string, string]): string;
    encodeFunctionData(functionFragment: 'withdrawDelegatesOf', values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: 'undelegateWithdraw', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'withdraw(address,uint256,address)', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'withdraw(address,uint256,address,address)', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'withdrawDelegatesOf', data: BytesLike): Result;
    events: {
...
export interface LendingPool extends BaseContract {
    ...
    functions: {
        ...
        delegateWithdraw(delegatee: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setConfiguration(asset: string, configuration: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        undelegateWithdraw(delegatee: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        'withdraw(address,uint256,address)'(asset: string, amount: BigNumberish, to: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        'withdraw(address,uint256,address,address)'(asset: string, amount: BigNumberish, to: string, onBehalfOf: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        withdrawDelegatesOf(user: string, overrides?: CallOverrides): Promise<[string[]]>;
    };
    FLASHLOAN_PREMIUM_TOTAL(overrides?: CallOverrides): Promise<BigNumber>;
    LENDINGPOOL_REVISION(overrides?: CallOverrides): Promise<BigNumber>;
    MAX_NUMBER_RESERVES(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        ...
        delegateWithdraw(delegatee: string, overrides?: CallOverrides): Promise<void>;
        ...
        undelegateWithdraw(delegatee: string, overrides?: CallOverrides): Promise<void>;
        'withdraw(address,uint256,address)'(asset: string, amount: BigNumberish, to: string, overrides?: CallOverrides): Promise<BigNumber>;
        'withdraw(address,uint256,address,address)'(asset: string, amount: BigNumberish, to: string, onBehalfOf: string, overrides?: CallOverrides): Promise<BigNumber>;
        withdrawDelegatesOf(user: string, overrides?: CallOverrides): Promise<string[]>;
    };
    filters: {
    ...
    estimateGas: {
        ...
        withdrawDelegatesOf(user: string, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        withdrawDelegatesOf(user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
