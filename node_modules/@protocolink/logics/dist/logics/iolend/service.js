    ...
    async getReserveTokens() {
        if (!this.reserveTokens || !this.reserveMap) {
            ...
            assetAddresses.forEach((assetAddress, i) => {
                ...
                const { aTokenAddress, stableDebtTokenAddress, variableDebtTokenAddress } = this.protocolDataProviderIface.decodeFunctionResult('getReserveTokensAddresses', returnData[i * 2 + 1]);
