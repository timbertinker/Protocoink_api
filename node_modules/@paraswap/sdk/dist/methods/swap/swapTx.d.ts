...
declare type SwapTxInputFields = 'srcToken' | 'destToken' | 'amount' | 'side' | 'srcDecimals' | 'destDecimals' | 'userAddress' | 'slippage';
declare type SwapTxInputListFields = 'includeDEXS' | 'excludeDEXS' | 'includeContractMethods' | 'excludeContractMethods' | 'route';
declare type SwapRateOptions = Omit<SwapQueryParams, SwapTxInputFields | SwapTxInputListFields | 'network' | 'version'> & {
    /**
...
declare type SwapTxInput = Pick<SwapQueryParams, SwapTxInputFields> & {
    /**
...
export declare type SwapTxResult = SwapApiResponse;
export declare type GetSwapTxData = (options: SwapTxInput, signal?: AbortSignal) => Promise<SwapTxResult>;
export declare type GetSwapTxFunctions = {
