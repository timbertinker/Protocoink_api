...
var _excluded$7 = ["tokenType", "mainConnector", "connectors", "network"];
var constructToken = function constructToken(tokenProps) {
  var _tokenProps$tokenType = tokenProps.tokenType,
      ...
      rest = _objectWithoutPropertiesLoose(tokenProps, _excluded$7);
...
var _excluded$6 = ["options"],
    _excluded2$3 = ["excludePricingMethods", "excludeContractMethods", "includeContractMethods", "partner", "includeDEXS", "excludeDEXS", "excludePools"];
var DEFAULT_PARTNER = 'paraswap.io';
function normalizeRateOptions(_ref) {
  var _ref$options = _ref.options,
      options = _ref$options === void 0 ? {} : _ref$options,
      restInput = _objectWithoutPropertiesLoose(_ref, _excluded$6);
  ...
  var excludePricingMethods = options.excludePricingMethods,
      ...
      restOptions = _objectWithoutPropertiesLoose(options, _excluded2$3);
...
var _excluded$5 = ["srcToken", "destToken"],
    _excluded2$2 = ["route"];
    ...
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_ref2, signal) {
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              srcToken = _ref2.srcToken, destToken = _ref2.destToken, rest = _objectWithoutPropertiesLoose(_ref2, _excluded$5);
...
var _excluded$4 = ["srcToken", "destToken", "amount", "route"];
    ...
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_ref2, signal) {
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              srcToken = _ref2.srcToken, destToken = _ref2.destToken, amount = _ref2.amount, route = _ref2.route, rest = _objectWithoutPropertiesLoose(_ref2, _excluded$4);
              parsedOptions = normalizeRateOptions(rest);
...
var constructSwapSDK = function constructSwapSDK(config) {
  return (// include all available Swap methods
    ...
    constructBuildTx, constructGetAdapters, constructGetRate, constructSwapTx)
  );
};
